...
const Register = () => {
  ...
  const handleSubmit = (e) => { e.preventDefault(); dispatch(registerUser({ name, email, password })); };

  useEffect(() => { if (userInfo) { toast.success("Registration Successful 🎉"); navigate("/"); } }, [userInfo, navigate]);
    ...
    <>
      ...
      <div className="auth-page">
        <div className="auth-left">
          <img className="auth-left-img" src="https://images.unsplash.com/photo-1514222134-b57cbb8ce073?q=80&w=1200&auto=format&fit=crop" alt="Temple"/>
          ...
          <div className="auth-left-content">
            ...
            <h2 className="auth-left-title">Join <em>Us</em> Today</h2>
            <p className="auth-left-sub">Create your account and explore the spiritual heritage of India's most sacred temples and pilgrimage destinations.</p>
            <div className="auth-left-stats">
              <div><div className="auth-left-stat-num">500<span>+</span></div><div className="auth-left-stat-label">Temples Listed</div></div>
              <div><div className="auth-left-stat-num">28</div><div className="auth-left-stat-label">States Covered</div></div>
            </div>
          </div>
        </div>
        ...
        <div className="auth-right">
          <div className="auth-form-wrap">
            ...
            <p className="auth-form-sub">Begin your spiritual journey today</p>

            <form onSubmit={handleSubmit}>
              <div className="auth-field">
                <label className="auth-field-label">Full Name</label>
                <input className="auth-field-input" type="text" placeholder="Your full name" value={name} onChange={(e) => setName(e.target.value)} required/>
              </div>
              <div className="auth-field">
              ...
              <div className="auth-field">
                ...
                <input className="auth-field-input" type="password" placeholder="Create a password" value={password} onChange={(e) => setPassword(e.target.value)} required/>
              </div>
